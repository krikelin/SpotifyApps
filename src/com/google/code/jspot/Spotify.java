...
public class Spotify {
     ...
     * @throws IOException
     */
    public Track lookupTrack(String uri) throws IOException {
        String encodedTrack = uri;//URLEncoder.encode(uri, "UTF-8");
        Document doc = commander.sendCommand("lookup/1/.xml?uri=" + encodedTrack);
        Element docElement = doc.getDocumentElement();
        ...
        Element trackNode = (Element) docElement;
    ...
    private static void test() throws IOException {
        ...
        // print out all of the tracks by weezer
